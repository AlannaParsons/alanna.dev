...
const goodlyFont = localFont({ src: "../fonts/Goodly-Light.otf" })
...
//palette ref https://coolors.co/28536b-c2948a-7ea8be-f6f0ed-bbb193
  ...
  components: {
    Text: {
      styles: {
        root: { fontSize: 18, fontFamily: goodlyFont.style.fontFamily },
      },
    },
    Title: {
      styles: {
        root: { fontFamily: milkyWalkyFont.style.fontFamily },
      },
    },
    Badge: {
      styles: {
        root: {  fontFamily:  ` Verdana, sans-serif, `},
      },
    },
  },
    
  // title: { fontFamily: milkyWalkyFont.style.fontFamily, },
